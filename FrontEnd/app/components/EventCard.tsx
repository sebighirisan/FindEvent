...
const EventCard = ({ event, onPressMap }: EventCardProps) => {
  ...
  return (
    <Pressable onPress={goToDetails} style={({ pressed }) => [{ opacity: pressed ? 0.95 : 1 }]}>
      <View style={styles.card}>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.typeContainer}>
            ...
            <Text style={{ ...styles.type, color: eventTypeColor }}>{event.type}</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  actionsRow: { flexDirection: "row", justifyContent: "space-between", marginTop: "auto" },
  mapButton: {
    flexDirection: "row",
    alignItems: "center",
  ...
  mapButtonText: { color: "#fff", marginLeft: 4, fontSize: 12, fontWeight: "600" },
  linkButton: {
    flexDirection: "row",
    alignItems: "center",
  ...
  linkButtonText: { color: "#fff", marginLeft: 4, fontSize: 12, fontWeight: "600" },
  ...
  mapPreviewLocation: { height: 300, width: "100%", borderRadius: 4, marginBottom: 12 },
});
