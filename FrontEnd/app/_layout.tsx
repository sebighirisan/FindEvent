  ...
  return (
    <Provider store={store}>
      <Stack>
        ...
        <Stack.Screen
          name="YourEvent"
          options={{ title: "YourEvent", headerShown: false }}
        />
        <Stack.Screen
          name="AdminLogin"
          options={{ title: "AdminLogin", headerShown: false }}
        />
        <Stack.Screen
          name="DashboardAdmin"
          options={{ title: "DashboardAdmin", headerShown: false }}
        />
        <Stack.Screen
          name="AdminVerifyEvent"
          options={{ title: "AdminVerifyEvent", headerShown: false }}
        />
      </Stack>
    </Provider>
  );
