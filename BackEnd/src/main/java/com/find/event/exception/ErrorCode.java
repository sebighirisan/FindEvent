...
public enum ErrorCode {
    ...
    INVALID_NUMERIC_VALUE("The value '%s' entered for '%s' is not a valid decimal"),
    INVALID_POSITIVE_VALUE("The value '%s' entered for '%s' should be greater than or equal to 0"),
    INVALID_LATITUDE("The value %d entered for latitude is invalid. Expected value should be within the interval [-90, 90]"),
    INVALID_LONGITUDE("The value %d entered for longitude is invalid. Expected value should be within the interval [-180, 180]"),
